...
void main() {
  ...
  vec3 col = vec3(121.0/255.0, 108.0/255.0, 103.0/255.0);
  //vec3 col = vec3(255.0/255.0, 255.0/255.0, 255.0/255.0);

  //lambertian shading calculation
  vec3 lightDir = normalize(vec3(0.0, 10.0, -10.0) - pos);
  vec3 lightDir2 = normalize(vec3(-10.0, 5.0, 10.0) - pos);
  vec3 lightDir3 = normalize(vec3(10.0, 5.0, 10.0) - pos);
